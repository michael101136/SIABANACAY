...
class NichosDisponibles extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data = array(
            'title' => 'DEPARTAMENTO',
            'provincias' => $this->Cuartel_model->reportedisponible_Nichos()
        );

        //hacemos que coja la vista como datos a imprimir
        //importante utf8_decode para mostrar bien las tildes, ñ y demás
        $this->html2pdf->html(utf8_decode($this->load->view('admin/Reporte/NichosDisponibles', $data, true)));
