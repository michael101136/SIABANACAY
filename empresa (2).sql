...
SELECT tcategoria.categoria, pasaje.nombrepasaje,tcuartel.nombre_cuartel FROM tcuartel inner join pasaje on tcuartel.id_pasaje=pasaje.id_pasaje inner join tcategoria on tcuartel.id_categoria=tcategoria.id_categoria;
END$$
